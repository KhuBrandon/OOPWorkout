...
void CHealth::cel2faren() { faren = cel * 9.0 / 5.0 + 32.0; } //inline으로 만들어진 함수를 health2.cpp에 구현
void CHealth::faren2cel() { cel = (faren - 32) * 5.0 / 9.0; }
void CHealth::GetHealthAge() { healthAge = beat / pressure; } //inline으로 만들어진 함수를 health2.cpp에 구현
